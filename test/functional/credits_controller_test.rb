...
class CreditsControllerTest < ActionController::TestCase
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post :create, credit: { article_id: @credit.article_id, user_id: @credit.user_id, verdict: @credit.verdict }
    end
  ...
  test "should update credit" do
    put :update, id: @credit, credit: { article_id: @credit.article_id, user_id: @credit.user_id, verdict: @credit.verdict }
    assert_redirected_to credit_path(assigns(:credit))
  end
