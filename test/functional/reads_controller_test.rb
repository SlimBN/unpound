...
class ReadsControllerTest < ActionController::TestCase
  ...
  test "should create read" do
    assert_difference('Read.count') do
      post :create, read: { article_id: @read.article_id, journal_id: @read.journal_id, user_id: @read.user_id }
    end
  ...
  test "should update read" do
    put :update, id: @read, read: { article_id: @read.article_id, journal_id: @read.journal_id, user_id: @read.user_id }
    assert_redirected_to read_path(assigns(:read))
  end
