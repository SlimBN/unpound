...
class FollowsControllerTest < ActionController::TestCase
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post :create, follow: { followee_id: @follow.followee_id, journal_id: @follow.journal_id, user_id: @follow.user_id }
    end
  ...
  test "should update follow" do
    put :update, id: @follow, follow: { followee_id: @follow.followee_id, journal_id: @follow.journal_id, user_id: @follow.user_id }
    assert_redirected_to follow_path(assigns(:follow))
  end
